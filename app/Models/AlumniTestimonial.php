...
/**
 * AlumniTestimonial Model (RT-03 — Alumni Menginspirasi)
 *
 * @author   DSE (Delia Tse)
 * @created  2026-08-08
 */

// [THECHNOLOGY-CRE] : AlumniTestimonial model
...
#[Fillable([
    'name', 'graduation_year', 'profession', 'quote',
    'sort_order', 'status', 'is_active', 'published_at',
])]
class AlumniTestimonial extends Model implements HasMedia
{
